...
p {
    ...
    <form action="{{route('admin.dologin')}}" method="post">
      @csrf
        <div class="inputBox"> <input id="uname" type="text" name="email" placeholder="Enter email"> <input id="pass" type="password" name="password" placeholder="Enter password"> </div> <input type="submit" name="" value="Login">
